...
<body>
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12">
                <form
                    action="<?php echo base_url().'/crearLibroFiltro'?>"
                    method="POST">
                    <label>Libro</label>
                    <input type="text" name="nombreLibro" id="nombreLibro" class="form-control" required
                        pattern="([A-zÀ-ž\s]){2,}">
                    <label>Año</label>
                    ...
                    <select name="tblImagen_idtblImagen" id="tblImagen_idtblImagen" class="form-control" required>
                        ...
                        <option
                            value="<?= $imagenData['IDimagen']?>">
                            <?=$imagenData['nombreImagen'];?>
                        </option>
                        <?php endforeach; ?>
                    </select>
                    ...
                    <select name="IDAutor" id="IDAutor" class="form-control" required>
                        ...
                        <option
                            value="<?= $autorData['IDAutor']?>">
                            <?=$autorData['nombreAutor'];?>
                        </option>
                        <?php endforeach; ?>
                    </select>
                    <label>Tags</label> <br>
                    ...
                    <select name="IDFiltro" id="IDFiltro" class="form-control" required>
                        ...
                        <option
                            value="<?= $filtroData['ID']?>">
                            <?=$filtroData['CIUDAD'].'/'.$filtroData['GESTION'].'/'.$filtroData['FACULTAD'].'/'.$filtroData['CARRERA'].'/'.$filtroData['SEMESTRE'].'/'.$filtroData['MATERIA'];?>
                        </option>
                        <?php endif; ?>
                        <?php endforeach; ?>
                    </select>
        ...
        <br>
        <div>
            <a class="btn btn-primary btn-lg btn-block" href="/librorelacion" role="button">Añadir mas autores y tags a
                un libro</a>
        </div>
            ...
            <div class="table table-responsive">
                <table class="table table-hover table-bordered table-dark">
                    ...
                    <tr>
                        ...
                        <?php if (($key['estado'])==1): ?>
                        <td><?php echo $key['nombreLibro'] ?>
                        </td>
                        <td><?php echo $key['year'] ?>
                        </td>
                        <td><?php echo $key['edicion'] ?>
                        </td>
                        <td><a
                                href="<?php echo $key['dirDoc'] ?>">Enlace</a>
                        </td>
                        <td><a
                                href="<?php echo $key['dirImagen']?>"><?php echo $key['nombreImagen'] ?></a>
                        </td>
                        <td><?php echo $key['autores'] ?>
                        </td>
                        <td><?php echo $key['tags'] ?>
                        </td>
                        <td><?php echo $key['filtros']?>
                        </td>
                        <td>
                        ...
                        <!-- <td>
                                <a href="<?php //echo base_url().'/eliminarLibroLogic/'.$key->idtblLibro?>"
    ...
    <script type="text/javascript">
        ...
        if (mensaje == '0') {
            ...
            swal('😑 ', 'Error en la insercion hay algo mal con la PK',
            'error'); //alert("No se agrego, error en la insercion");    
        } else if (mensaje == '2') {
    ...
    <script type="text/javascript">
        var baseURL =
            "<?php echo base_url().'/obtenerNombreLibroFiltro/'?>";
