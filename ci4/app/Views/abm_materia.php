...
<body>
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12">
                <form action="<?php echo base_url().'/crearMateria'?>" method="POST">
                    <label>Materia</label>
            ...
            <div class="col-sm-12">
                <div class="table table-responsive">
                    <table class="table table-hover table-bordered table-dark">
                        ...
                        <tr>
                            <td><?php echo $key->nombreMateria ?>
                            </td>
                            <td>
                                <a href="<?php echo base_url().'/obtenerNombreMateria/'.$key->idtblMateria //basicamente obtiene el id para poder hace el update?>"
                                    class="btn btn-warning btn-small">Editar</a>
                            </td>
                            <td>
                                <a href="<?php echo base_url().'/eliminarMateria/'.$key->idtblMateria ?>" class="btn btn-danger btn-small">Eliminar</a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </table>
