...
<script type="module">
    ...
    var dropValues = function(cell, formatterParams) {
        ...
        return "<select class='form-control' name='niv'> <option>"+valor+"</option><?php foreach ($nivel as $niveles):?><option value='<?=$niveles['ID'];?>'><?=$niveles['NIVEL'];?></option>?><?php endforeach;?></select>";
    }
