        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="table table-responsive">
                    <table class="table table-hover table-bordered table-dark" id="reporteusuarioactivo">
                        <tr>
                            <th>Nombre</th>
                            <th>Apellido</th>
                        ...
                        <?php foreach ($usuario as $key): ?>
                            ...
                            <td><?php echo $key['nombreNivel']?></td>
                            <td><?php echo $key['email']?></td>
                            <td><?php echo $key['suscrito']?></td>
                        </tr>
                        <?php endforeach; ?>
                    </table>
                </div>
    ...
    function fnExcelReport()
{
    ...
    tab = document.getElementById('reporteusuarioactivo'); // id of table
...
function generate() {  
    ...
    var y = 20;  
    doc.setLineWidth(2);  
    doc.text(200, y = y + 30, "REPORTE DE USUARIOS ACTIVOS");  
    doc.autoTable({  
        html: '#reporteusuarioactivo', 
        startY: 70,  
        theme: 'striped',  
        columnStyles: {  
            0: {  
