        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="table table-responsive">
                    <table class="table table-hover table-bordered table-dark" id="reporteusuarioexamen">
                        <tr>
                            <th>Nombre</th>
                            <th>Apellido</th>
    ...
    function fnExcelReport()
{
    ...
    tab = document.getElementById('reporteusuarioexamen'); // id of table
