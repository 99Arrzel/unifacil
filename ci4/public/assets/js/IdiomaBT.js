 ...
 $.fn.bootstrapTable.locales['es-AR'] = {
    ...
    formatShowingRows (pageFrom, pageTo, totalRows, totalNotFiltered) {
      if (totalNotFiltered !== undefined && totalNotFiltered > 0 && totalNotFiltered > totalRows) {
        return `Muestra desde ${pageFrom} a ${pageTo} de ${totalRows} filas (filtrado de ${totalNotFiltered} columnas totales)`
      }
  
      return `Muestra desde ${pageFrom} a ${pageTo} de ${totalRows} filas`
    },
    ...
    formatDetailPagination (totalRows) {
      return `Muestra ${totalRows} columnas`
    },
    formatClearSearch () {
